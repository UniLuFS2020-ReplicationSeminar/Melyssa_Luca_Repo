...
```{r warning=FALSE, message=FALSE}
paneldata_long <- read.dta("Problem Set 4/01 Data/paneldata_long.dta")
paneldata_wide <- read.dta("Problem Set 4/01 Data/paneldata_wide.dta")
partypositions <- rio::import("Problem Set 4/01 Data/partypositions.sav")
...
]{.ul}Research question: "What is the effect of socialist parties entry on the electoral competition and the coordination among the established parties?"\
Walter (20202) employs "a regression discontinuity design to estimate the casual effect of socialist entry to the electoral arena on the formation of electoral alliances and the support of established parties" (ibid).
...
[Data & methods:\
]{.ul}The author uses data fo Imperial Germany (1890 - 1912). He focuses on the strategic behavior of non-socialist parties in all the runoffs between 1890 and 1912. Of interest is the reaction of the increasing strength of the SPD.\
Walter (2020) notes that the "majority runoff system mimics a natural experiment by comparing strategic voter and party behavior between the first and second round. Because of the short time frame between the elections structural influences are essentially held constant.\
...
From this point on I'm not able to replicate the paper further
